...
// ---------- i18n ----------
const I18N={
 en:{repository:'Repository',local:'Local',remoteUrl:'Remote URL',browse:'Browse',pastePath:'Paste path or browse',
 ...
 fr:{repository:'Dépôt',local:'Local',remoteUrl:'URL distante',browse:'Parcourir',pastePath:'Coller un chemin ou parcourir',
...
// auto-trigger graph when the user finishes typing/pasting a repo
