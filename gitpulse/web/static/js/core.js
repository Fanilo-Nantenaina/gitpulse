...
const I18N = {
  en: {
    ...
    startOllama: 'Start Ollama', ollamaStarting: 'Starting Ollama...', custom: 'Custom...', loadingProviders: 'Checking providers...', ollamaNoModels: 'Server running, but no models pulled yet. Pull one:', loading: 'Loading...', loadMore: 'Load more', allCommits: 'All commits', commitCount: 'Commits to load', allBranches: 'All branches', authorFilter: 'Authors', authorLoading: 'Loading authors...', authorNone: 'No authors in range', authorSelectRepo: 'Select a repository first', authorError: 'Could not load authors', authorAll: 'All authors', authorSearchPh: 'Search authors...', authorSelectedN: 'selected', authorNoMatch: 'No match', currentBranch: 'current', latestBranch: 'latest', statCommits: 'Commits', statLines: 'Lines', statFiles: 'Files', statActiveDays: 'Active days', statAuthors: 'Authors', chartPerDay: 'Commits per day', chartChurn: 'Lines changed per day', chartAuthors: 'Commits by author', chartHours: 'Activity by hour', chartTopFiles: 'Most-changed files', statsLoading: 'Loading charts...', dashFailed: 'failed', reason_auth: 'authentication', reason_not_found: 'not found', reason_network: 'network', reason_other: 'error', selectRepoGraph: 'Select a repository to view its graph.', commitMessage: 'Commit message', changesScope: 'Changes', scopeAll: 'All (staged + unstaged)', scopeStaged: 'Staged only', generateMsg: 'Generate message', generatingMsg: 'Analyzing changes...', noChanges: 'No uncommitted changes.', subject: 'Subject', changes: 'Changes', copy: 'Copy', copied: 'Copied!', diffTruncated: 'diff truncated', commitTab: 'Commit', selectRepoCommit: 'Select a local repository to generate a commit message.', commitType: 'Type', typeAuto: 'Auto-detect', regenerate: 'Regenerate', uncommittedShort: 'uncommitted', uncommittedFull: 'Uncommitted changes', commitHint: 'You have uncommitted changes — generate a commit message.',
    fallbackNote: 'The AI model’s reply didn’t match the expected format, so this is an offline summary instead.', fallbackDetail: 'Show technical details',
    summarizing: 'Summarizing', cancel: 'Cancel', cancelled: 'Cancelled.', slowLocalHint: 'Local models can take a while, especially the first run after idling.',
  ...
  fr: {
    ...
    startOllama: 'Démarrer Ollama', ollamaStarting: 'Démarrage d\'Ollama...', custom: 'Personnalisé...', loadingProviders: 'Vérification des fournisseurs...', ollamaNoModels: 'Serveur démarré, mais aucun modèle installé. Installez-en un :', loading: 'Chargement...', loadMore: 'Charger plus', allCommits: 'Tous les commits', commitCount: 'Commits à charger', allBranches: 'Toutes les branches', authorFilter: 'Auteurs', authorLoading: 'Chargement des auteurs...', authorNone: 'Aucun auteur sur la période', authorSelectRepo: 'Sélectionnez d\'abord un dépôt', authorError: 'Impossible de charger les auteurs', authorAll: 'Tous les auteurs', authorSearchPh: 'Rechercher un auteur...', authorSelectedN: 'sélectionnés', authorNoMatch: 'Aucune correspondance', currentBranch: 'actuelle', latestBranch: 'récente', statCommits: 'Commits', statLines: 'Lignes', statFiles: 'Fichiers', statActiveDays: 'Jours actifs', statAuthors: 'Auteurs', chartPerDay: 'Commits par jour', chartChurn: 'Lignes modifiées par jour', chartAuthors: 'Commits par auteur', chartHours: 'Activité par heure', chartTopFiles: 'Fichiers les plus modifiés', statsLoading: 'Chargement des graphiques...', dashFailed: 'en échec', reason_auth: 'authentification', reason_not_found: 'introuvable', reason_network: 'réseau', reason_other: 'erreur', selectRepoGraph: 'Sélectionnez un dépôt pour afficher son graphe.', commitMessage: 'Message de commit', changesScope: 'Changements', scopeAll: 'Tout (indexé + non indexé)', scopeStaged: 'Indexé uniquement', generateMsg: 'Générer le message', generatingMsg: 'Analyse des changements...', noChanges: 'Aucun changement non commité.', subject: 'Résumé', changes: 'Changements', copy: 'Copier', copied: 'Copié !', diffTruncated: 'diff tronqué', commitTab: 'Commit', selectRepoCommit: 'Sélectionnez un dépôt local pour générer un message de commit.', commitType: 'Type', typeAuto: 'Détection auto', regenerate: 'Régénérer', uncommittedShort: 'non commités', uncommittedFull: 'Changements non commités', commitHint: 'Vous avez des changements non commités — générez un message de commit.',
    fallbackNote: 'La réponse du modèle IA ne correspondait pas au format attendu : voici un résumé hors-ligne à la place.', fallbackDetail: 'Voir les détails techniques',
    summarizing: 'Résumé en cours', cancel: 'Annuler', cancelled: 'Annulé.', slowLocalHint: 'Les modèles locaux peuvent prendre du temps, surtout au premier appel après une pause.',
...
function onRepoChanged() {
  loadBranches();
  updateChangesBadge();
  if ((state.action === 'summary' || state.action === 'log') && typeof loadAuthorsFilter === 'function') loadAuthorsFilter();
