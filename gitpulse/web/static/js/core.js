...
const I18N = {
  en: {
    ...
    startOllama: 'Start Ollama', ollamaStarting: 'Starting Ollama...', custom: 'Custom...', loadingProviders: 'Checking providers...', ollamaNoModels: 'Server running, but no models pulled yet. Pull one:', loading: 'Loading...', loadMore: 'Load more', allCommits: 'All commits', commitCount: 'Commits to load', allBranches: 'All branches', authorFilter: 'Authors', authorLoading: 'Loading authors...', authorNone: 'No authors in range', authorSelectRepo: 'Select a repository first', authorError: 'Could not load authors', selectRepoGraph: 'Select a repository to view its graph.', commitMessage: 'Commit message', changesScope: 'Changes', scopeAll: 'All (staged + unstaged)', scopeStaged: 'Staged only', generateMsg: 'Generate message', generatingMsg: 'Analyzing changes...', noChanges: 'No uncommitted changes.', subject: 'Subject', changes: 'Changes', copy: 'Copy', copied: 'Copied!', diffTruncated: 'diff truncated', commitTab: 'Commit', selectRepoCommit: 'Select a local repository to generate a commit message.', commitType: 'Type', typeAuto: 'Auto-detect', regenerate: 'Regenerate', uncommittedShort: 'uncommitted', uncommittedFull: 'Uncommitted changes', commitHint: 'You have uncommitted changes — generate a commit message.',
...
function onRepoChanged() {
  loadBranches();
  updateChangesBadge();
  if ((state.action === 'summary' || state.action === 'log') && typeof loadAuthorsFilter === 'function') { const a = document.getElementById('ctlAuthor'); if (a) a.dataset.loaded = '0'; loadAuthorsFilter(); }
